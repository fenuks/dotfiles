...
export JAVA_TOOLS_OPTIONS="-javaagent:${HOME}/.m2/repository/org/projectlombok/lombok/${LOMBOK_VERSION}/lombok-${LOMBOK_VERSION}.jar -Xbootclasspath/p:${HOME}/.m2/repository/org/projectlombok/lombok/${LOMBOK_VERSION}/lombok-${LOMBOK_VERSION}.jar"
